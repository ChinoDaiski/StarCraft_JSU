...
CSkillButton::CSkillButton(BUTTON_SKILL _eButtonInfo)
...
void CSkillButton::Initialize(void)
{
	m_DC = CBitmapMgr::Get_Instance()->Find_Image(L"Skill");
}

int CSkillButton::Update(void)
{
...
int CSkillButton::Late_Update(void)
{
	return 0;
}
...
void CSkillButton::Release(void)
{
}

void CSkillButton::Click(void)
{
	m_iDrawID = 1;
