...
int CScout::Update(void)
{
	if (m_bDead) {
		...
		CSoundMgr::Get_Instance()->PlaySoundW(L"PScDth00.wav", CHANNELID::Enemy, UNIT_SOUND);
		return OBJ_DEAD;
	}
...
void CScout::Update_State(void)
{
	...
	case UNIT_STATE::Attack:
		...
		if (dwFrameTime + dwFrameSpeed < GetTickCount())
		{
			...
			CEffectMgr::Get_Instance()->Create_Effect(EFFECT::SCOUT_GROUND, pt.x, pt.y, 80, 80);
		}
